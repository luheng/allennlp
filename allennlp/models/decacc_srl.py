...
@Model.register("decacc_srl")
class DecAccSRL(Model):
    """
    ...
    def __init__(self, vocab: Vocabulary,
        ...
        super(DecAccSRL, self).__init__(vocab)
    ...
    def forward(self,  # type: ignore
        ...
        projected_premise = self._attend_feedforward(srl_embedded_premise)
        projected_hypothesis = self._attend_feedforward(srl_embedded_hypothesis)
